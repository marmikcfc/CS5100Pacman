...
import pacman.controllers.algoControllers.perceptronController;
 ...
 */
public class myPerceptronPacman extends Controller<MOVE>
{
        private perceptronController perceptron;
	private MOVE myMove=MOVE.NEUTRAL;
	private static final int MIN_DISTANCE=20;	//if a ghost is this close, run away

        public myPerceptronPacman(){
        
             perceptron=new perceptronController();
