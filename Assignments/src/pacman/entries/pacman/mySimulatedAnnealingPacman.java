...
import pacman.controllers.algoControllers.SimulatedAnnealingController;
...
public class mySimulatedAnnealingPacman extends Controller<MOVE>
{
        private SimulatedAnnealingController sa;
	private MOVE myMove=MOVE.NEUTRAL;
	private static final int MIN_DISTANCE=20;	//if a ghost is this close, run away

        public mySimulatedAnnealingPacman(){
        
             sa=new SimulatedAnnealingController();
	...
	public MOVE getMove(Game game, long timeDue) 
	{
		...
		return sa.getMove(ghostMoves, tree);
