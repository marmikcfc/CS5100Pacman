...
import pacman.controllers.algoControllers.HillClimbingController;
...
public class myHillClimberPacMan extends Controller<MOVE>
{
        private HillClimbingController hillclimber;
	private MOVE myMove=MOVE.NEUTRAL;
	private static final int MIN_DISTANCE=20;	//if a ghost is this close, run away

        public myHillClimberPacMan(){
        
             hillclimber=new HillClimbingController();
